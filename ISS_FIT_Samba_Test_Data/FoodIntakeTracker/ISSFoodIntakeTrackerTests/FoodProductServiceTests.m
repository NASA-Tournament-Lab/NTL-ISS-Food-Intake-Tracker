...
-(void)setUp {
    ...
    foodProductService = [[FoodProductServiceImpl alloc] initWithManagedObjectContext:self.managedObjectContext];
    userService = [[UserServiceImpl alloc] initWithManagedObjectContext:self.managedObjectContext
                                                          configuration:self.configurations lockService:nil];
}
