...
-(void)setUp {
    ...
    lockService = [[LockServiceImpl alloc] initWithConfiguration:self.configurations];
                   
    userService = [[UserServiceImpl alloc] initWithConfiguration:self.configurations
