...
#define PACKAGE_STRING "PostgreSQL 9.2.4"
...
#define PG_VERSION_STR "PostgreSQL 9.2.4 on arm-apple-darwin, compiled by Apple LLVM version 5.1 (clang-503.0.40) (based on LLVM 3.4svn), 32-bit"
