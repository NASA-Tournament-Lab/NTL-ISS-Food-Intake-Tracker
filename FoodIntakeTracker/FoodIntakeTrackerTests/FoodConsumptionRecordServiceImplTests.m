...
{
    [super setUp];
    self.service = [[FoodConsumptionRecordServiceImpl alloc] initWithConfiguration:self.configurations];
    self.userService = [[UserServiceImpl alloc] init];
    NSError *error = nil;
    BaseCommunicationDataService *baseService = [[BaseCommunicationDataService alloc] initWithConfiguration:self.configurations];
...
- (void)testInitObject
{
    ...
    self.service = [[FoodConsumptionRecordServiceImpl alloc] initWithConfiguration:configurations];
...
- (void)testCopyFoodConsumptionRecord
{
    ...
    STAssertEquals(copy.quantity.intValue, 2, @"should have equal quantity");
