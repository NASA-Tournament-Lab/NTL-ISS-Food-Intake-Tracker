...
- (void)testBuildUserFromData {
    NSArray *data = @[@"NO",@"Kevin Lee",@"kl1.png;kl2.png",@"Chicken",@"USA",@"Food",@"7",
                      @"Z_TO_A",@"NO",@"30",@"20",@"20",@"5",@"kl1.png",@"YES",@"224555476",@"224555476"];
    NSError *error = nil;
...
- (void)testBuildFoodConsumptionRecordFromData {
    NSArray *data = @[@"Black Coffee",@"Joe Norton",@"2007885226",@"2",@"Two cups of coffee",@"bc1.png",@"voice1.wav",
                      @"20",@"20",@"20",@"NO",@"2244554444",@"2244554444"];
    NSError *error = nil;
    ...
    STAssertEquals(record.quantity, @2, @"should have equal quantity");
...
- (void)testBuildAdhocFoodProductFromData {
    ...
    NSArray *data = @[@"Chicken",@"22255477",@"c1.png;c2.png",@"USA",@"Food",@"20",@"20",@"20",@"c1.png",@"Joe Norton",
