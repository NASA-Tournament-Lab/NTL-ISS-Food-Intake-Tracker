...
- (BOOL)copyLocalFile:(NSString *)localFile toSMBPath:(NSString *)smbPath error:(NSError **)error {
    ...
    NSError *e = nil;
    id<SMBClient> client = [[[BaseCommunicationDataService alloc] initWithManagedObjectContext:self.managedObjectContext
...
- (void)setUp {
    [super setUp];
    self.service = [[SynchronizationServiceImpl alloc] initWithManagedObjectContext:self.managedObjectContext
                                                                      configuration:self.configurations];
    ...
    id<FoodProductService> foodService = [[FoodProductServiceImpl alloc]
    ...
    // create food data
    NSArray *foodData = @[@"food1",@"22255477",@"f1.png",@"USA",@"Food",@"20",@"20",@"20",@"f1.png",
    ...
    NSArray *foodRecordData = @[@"food1",@"user1",@"2007885226",@"2",@"Two cups of coffee",
                                @"f.png",@"voice2.wav",@"20",@"20",@"20",@"NO",@"2244554444",@"2244554444"];
    FoodConsumptionRecord *record = [DataHelper
                                      buildFoodConsumptionRecordFromData:foodRecordData
                                      inManagedObjectContext:self.managedObjectContext
                                      error:&error];
    id<FoodConsumptionRecordService> consumptionRecordService = [[FoodConsumptionRecordServiceImpl alloc]
                                                                 initWithManagedObjectContext:self.managedObjectContext];
...
- (void)testSynchronizesynchronize {
    ...
    NSString *userLine = @"\"NO\",\"user1\",\"user1.png\",\"test_filter\",\"China\",\"Cookie\",\"10\",\"2\",\"NO\","
                        "\"100\",\"1000\",\"20\",\"2\",\"user1.png\",\"NO\",\"1376229595\",\"1376229595\"\r\n";
